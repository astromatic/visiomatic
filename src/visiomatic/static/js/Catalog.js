...
Catalog.PanSTARRS1 = extend({}, Catalog, {
	service: 'Vizier@CDS',
	name: 'PanSTARRS 1',
	className: 'logo-catalog-vizier',
...
Catalog.AllWISE = extend({}, Catalog, {
	service: 'Vizier@CDS',
	name: 'AllWISE',
	className: 'logo-catalog-vizier',
...
Catalog.GALEX_AIS = extend({}, Catalog, {
	service: 'Vizier@CDS',
	name: 'GALEX AIS',
	className: 'logo-catalog-vizier',
...
Catalog.GAIA_DR1 = extend({}, Catalog, {
	service: 'Vizier@CDS',
	name: 'Gaia DR1',
	className: 'logo-catalog-vizier',
...
Catalog.GAIA_DR2 = extend({}, Catalog, {
	service: 'Vizier@CDS',
	name: 'Gaia DR2',
	className: 'logo-catalog-vizier',
